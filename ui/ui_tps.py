...
class Ui_TandaPaySimulationWindow(object):
    def setupUi(self, TandaPaySimulationWindow):
        ...
        sizePolicy3.setHeightForWidth(self.g_ev0.sizePolicy().hasHeightForWidth())
        self.g_ev0.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_ev2.sizePolicy().hasHeightForWidth())
        self.g_ev2.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_ev3.sizePolicy().hasHeightForWidth())
        self.g_ev3.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_ev4.sizePolicy().hasHeightForWidth())
        self.g_ev4.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_ev5.sizePolicy().hasHeightForWidth())
        self.g_ev5.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_ev6.sizePolicy().hasHeightForWidth())
        self.g_ev6.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_ev7.sizePolicy().hasHeightForWidth())
        self.g_ev7.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_pv0.sizePolicy().hasHeightForWidth())
        self.g_pv0.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_pv1.sizePolicy().hasHeightForWidth())
        self.g_pv1.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_pv2.sizePolicy().hasHeightForWidth())
        self.g_pv2.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_pv3.sizePolicy().hasHeightForWidth())
        self.g_pv3.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_pv4.sizePolicy().hasHeightForWidth())
        self.g_pv4.setSizePolicy(sizePolicy3)
        ...
        sizePolicy3.setHeightForWidth(self.g_pv5.sizePolicy().hasHeightForWidth())
        self.g_pv5.setSizePolicy(sizePolicy3)
    ...
    def retranslateUi(self, TandaPaySimulationWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"EV1 - Members in group", None))
...
#endif // QT_CONFIG(tooltip)
        self.label_9.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"EV6 - Members who are unwilling to act alone(%)", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_10.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"EV7 - Member threshold for dependent members to defect", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_11.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"EV8 - Additional periods once the group stabilizes", None))
#if QT_CONFIG(tooltip)
        ...
        self.label_13.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"PV1 - Lower threshold of premium price", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_14.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"PV2 - Policyholders decide to leave before:", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_15.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"PV3 - Upper threshold of premium price", None))
        self.label_16.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"PV4- Policyholders deciding to leave result in(%)", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_17.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"PV5 - Lower threshold of premium price sensitivity(%)", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(tooltip)
        self.label_18.setText(QCoreApplication.translate("TandaPaySimulationWindow", u"PV6 - Policyholders leaving every period(%)", None))
#if QT_CONFIG(tooltip)
