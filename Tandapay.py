...
class Simulator:
    ...
    def startAction(self, vector=None):
...
def main():
    ...
    # simulator = Simulator(ui=False, _matrix=[[60, 1000, 40, 15, 10, 65, 2, 3, 0.33333, 20, 4, 70, 8, 77, 3], [60, 1000, 40, 15, 10, 65, 3, 3, 0.33333, 20, 4, 70, 8, 77, 3]])
